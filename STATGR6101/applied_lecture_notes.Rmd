...
](/Users/h2jw/Documents/GitHub/STATGRXXXX/STATGR6101/images/galton.png)
...
*Summary of 4,5* 
![](/Users/h2jw/Documents/GitHub/STATGRXXXX/STATGR6101/images/resume45.png)
...
\begin{eqnarray*}  
H_{p0}: Z(t) ~ Z(t-1) & \cdots & Z(t-(p-1)) \\
H-{pa}:Z(t) ~ Z(t-1) & \cdots & Z(t-p) \\
& \vdots & \\
H_{j0}: Z(t) ~ Z(t-1) & \cdots & Z(t-(j-1)) \\
H-{ja}:Z(t) ~ Z(t-1) & \cdots & Z(t-j) \\
\end{eqnarray*}
...
Issue in $R^2 = \frac{SSE}{SST}$ through $SSE$, then adjust through the DF $adj. R^2 = 1- \frac{SSE/(n-|\mathcal{M}|)}{SST/(n-1)}$.

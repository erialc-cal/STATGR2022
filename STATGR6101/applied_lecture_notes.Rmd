...
birthrates <- read.table("/Users/clairehe/Downloads/cohort.dat") 
          # header=TRUE, skip=3)
```
...
```{r}
lmfit <- lm(Birthrate ~ poly(Year, 5), data=birhtrates)
plot(birthrates, pch=19, col='darkorange')
...
for (i in 1:8){
  mybasis[,1]=birthrates$Year >= 1917 + 1*10
}
...
lines(seq(1917, 20003), predict(fit, seq(1917,2003)$y, col='deepskyblue', lty=1,lwd=3))
```

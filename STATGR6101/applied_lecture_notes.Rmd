...
summary(fit)
```
Read that a female black student in grade 3 with no economic disadvantage has an average 64 on test scores. Read grade4 says that if she was in grade 4, would average go up with 4.57 points. 
...
#contrasts(tli$ethnicity)=contr.sum(4) 
fit <- lm(tlimth ~., data=tli)
summary(fit)
```
